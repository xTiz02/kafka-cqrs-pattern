...
public class KafkaConsumerConfig {
    ...
    @Bean
    public JsonDeserializer<ProductEvent> jsonDeserializer(){
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, ProductEvent>> listenerContainerFactory(ConsumerFactory consumerFactory) {
